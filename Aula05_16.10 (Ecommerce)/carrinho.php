<?php
include('cabelholoja.php');

$idusuario = $_SESSION['idusuario'];

#Pesquisa identificador do carrinho
$sql = "SELECT c.car_id, c.fk_cli_id. c.car_finalizado, p.prod_id, p.prod_nome, p.prod_descricao, p.prod_valor, p.prod_imagem, ic.car_item_quantidade, ic.fk_car_id, ic.fk_pro_id FROM carrinho c JOIN item_carinho ic ON c.car_id = ic.fk_car_id JOIN produtos p ON ic.fk_pro_id = p.pro_id WHERE c.fk_cli_id = $idusuario AND c.car_finalizado='n'";
...
<body>
    ...
    while ($tbl = mysqli_fetch_array($retorno)){
        ...
        <div class="main-content">
            ...
            class="butao">Excluir do carrinho</button>
        </div>
    <?php
    }
    ?>
